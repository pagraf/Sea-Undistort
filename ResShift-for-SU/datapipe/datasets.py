...
class InpaintingDataSetVal(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Image mask: immer mit .png einlesen
        mask_filename = Path(im_path).stem + ".png"
        mask_path = Path(self.mask_path) / mask_filename
        im_mask = util_image.imread(mask_path, chn='gray', dtype='float32')
